 ...
 * @version:
 * @Author: zixi
 * @Date: 2023-07-04 16:04:56
 * @LastEditors: zixi
 * @LastEditTime: 2023-07-04 18:07:52
 */
/*
...
function createHandler(opts) {
  ...
  app.get('/', function (req, res) {
    ...
    core.render(null, res, origUrl,query);
  });
  ...
  app.get('/object', async function (req, res) {
    res.json(await core.getCoverageObject() || {});
  });
  ...
  app.get('/download', async function (req, res) {
    var stream = archiver.createZip(),
      ...
      coverageObject = await core.getCoverageObject() || {},
  ...
  app.post('/client', function (req, res) {
    ...
    console.log('新增？？？',body.appId);
   const result =  core.mergeClientCoverage(body);
    res.json(result);
  });
